<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="active"><a class="nav-link" href="{{ route('pegawaiinternal') }}"><i class="far fa-square"></i> <span>Pegawai Internal</span></a></li>
          <li class="active"><a class="nav-link" href="{{ route('area') }}"><i class="far fa-square"></i> <span>Area Pekerjaan</span></a></li>
          <li class="nav-item dropdown">
